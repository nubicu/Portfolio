...
<html>
  <head>
    ...
    <title>Autentificarea - PHP</title>
  </head>
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#"><?php echo $lang['aboutme'] ?></a>
              </li>
            </ul>
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="autentificare.php?lang=ro"><?php echo $lang['romanian'] ?></a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="autentificare.php?lang=en"><?php echo $lang['english'] ?></a>
              </div>
            </div>
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="autentificare.php"><button class="btn btn-primary" type="button" name="button"><?php echo $lang['login'] ?></button></a>
              </li>
              <li class="nav-item">
      ...
      <div class="col-lg-6">
        <form class="" action="login.php" method="post">
          ...
          <div class="text-center">
            <button class="btn btn-primary" type="submit" name="button">Autentificare</button>
